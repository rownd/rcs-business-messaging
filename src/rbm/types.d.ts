...
export class Resource$Phones {
   ...
   */
  getCapabilities(
    params: Params$Resource$Phones$Getcapabilities,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  getCapabilities(
    params?: Params$Resource$Phones$Getcapabilities,
    options?: MethodOptions
  ): GaxiosPromise<Schema$Capabilities>;
  getCapabilities(
    params: Params$Resource$Phones$Getcapabilities,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  getCapabilities(
    params: Params$Resource$Phones$Getcapabilities,
    options: MethodOptions | BodyResponseCallback<Schema$Capabilities>,
    callback: BodyResponseCallback<Schema$Capabilities>
  ): void;
  getCapabilities(
    params: Params$Resource$Phones$Getcapabilities,
    callback: BodyResponseCallback<Schema$Capabilities>
...
export interface Params$Resource$Phones$Getcapabilities
...
export class Resource$Phones$Agentevents {
   ...
   */
  create(
    params: Params$Resource$Phones$Agentevents$Create,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  create(
    params?: Params$Resource$Phones$Agentevents$Create,
    options?: MethodOptions
  ): GaxiosPromise<Schema$AgentEvent>;
  create(
    params: Params$Resource$Phones$Agentevents$Create,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  create(
    params: Params$Resource$Phones$Agentevents$Create,
    options: MethodOptions | BodyResponseCallback<Schema$AgentEvent>,
    callback: BodyResponseCallback<Schema$AgentEvent>
  ): void;
  create(
    params: Params$Resource$Phones$Agentevents$Create,
    callback: BodyResponseCallback<Schema$AgentEvent>
...
export interface Params$Resource$Phones$Agentevents$Create
  extends StandardParameters {
  /**
   * The ID of the event, assigned by the agent. This must be a UUID, as defined in https://tools.ietf.org/html/rfc4122. The RBM platform ignores any agent message sent with an ID that was used by an earlier message or event sent from the same agent.
   */
...
export class Resource$Phones$Agentmessages {
   ...
   */
  create(
    params: Params$Resource$Phones$Agentmessages$Create,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  create(
    params?: Params$Resource$Phones$Agentmessages$Create,
    options?: MethodOptions
  ): GaxiosPromise<Schema$AgentMessage>;
  create(
    params: Params$Resource$Phones$Agentmessages$Create,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  create(
    params: Params$Resource$Phones$Agentmessages$Create,
    options: MethodOptions | BodyResponseCallback<Schema$AgentMessage>,
    callback: BodyResponseCallback<Schema$AgentMessage>
  ): void;
  create(
    params: Params$Resource$Phones$Agentmessages$Create,
    callback: BodyResponseCallback<Schema$AgentMessage>
   ...
   */
  delete(
    params: Params$Resource$Phones$Agentmessages$Delete,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  delete(
    params?: Params$Resource$Phones$Agentmessages$Delete,
...
export interface Params$Resource$Phones$Agentmessages$Create
  extends StandardParameters {
  /**
   * The unique ID of the message, assigned by the agent. This must be a UUID, as defined in https://tools.ietf.org/html/rfc4122. The RBM platform ignores any agent message sent with an ID that was used by an earlier message or event sent from the same agent.
   */
...
export interface Params$Resource$Phones$Agentmessages$Delete
  extends StandardParameters {
  /**
   * "phones/{E.164}/agentMessages/{messageId}", where {E.164} is the user's phone number in E.164 format and {messageId} is the agent-assigned ID of the agent message that should be revoked. For example, with the US phone number +1-222-333-4444 and an agent message with the ID "12345xyz", the resulting endpoint would be https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/agentMessages/12345xyz.
   */
...
export class Resource$Phones$Capability {
  ...
  requestCapabilityCallback(
    params: Params$Resource$Phones$Capability$Requestcapabilitycallback,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  requestCapabilityCallback(
    params?: Params$Resource$Phones$Capability$Requestcapabilitycallback,
...
export interface Params$Resource$Phones$Capability$Requestcapabilitycallback
  extends StandardParameters {
  /**
   * "phones/{E.164}/capability", where {E.164} is the user's phone number in E.164 format. For example, with the US phone number +1-222-333-4444, the resulting endpoint would be https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/capability:requestCapabilityCallback
   */
...
export class Resource$Phones$Dialogflowmessages {
   ...
   */
  create(
    params: Params$Resource$Phones$Dialogflowmessages$Create,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  create(
    params?: Params$Resource$Phones$Dialogflowmessages$Create,
    options?: MethodOptions
  ): GaxiosPromise<Schema$DialogflowEvent>;
  create(
    params: Params$Resource$Phones$Dialogflowmessages$Create,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  create(
    params: Params$Resource$Phones$Dialogflowmessages$Create,
    options: MethodOptions | BodyResponseCallback<Schema$DialogflowEvent>,
    callback: BodyResponseCallback<Schema$DialogflowEvent>
  ): void;
  create(
    params: Params$Resource$Phones$Dialogflowmessages$Create,
    callback: BodyResponseCallback<Schema$DialogflowEvent>
...
export interface Params$Resource$Phones$Dialogflowmessages$Create
  extends StandardParameters {
  /**
   * A unique prefix of RBM message IDs that result from the Dialogflow event. Dialogflow supports multiple responses for a given event. If an event triggers multiple responses, RBM forwards each response as a separate message. Each message ID shares the same prefix.
   */
...
export class Resource$Phones$Testers {
   ...
   */
  create(
    params: Params$Resource$Phones$Testers$Create,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  create(
    params?: Params$Resource$Phones$Testers$Create,
    options?: MethodOptions
  ): GaxiosPromise<Schema$Tester>;
  create(
    params: Params$Resource$Phones$Testers$Create,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  create(
    params: Params$Resource$Phones$Testers$Create,
    options: MethodOptions | BodyResponseCallback<Schema$Tester>,
    callback: BodyResponseCallback<Schema$Tester>
  ): void;
  create(
    params: Params$Resource$Phones$Testers$Create,
    callback: BodyResponseCallback<Schema$Tester>
...
export interface Params$Resource$Phones$Testers$Create
  extends StandardParameters {
  /**
   * "phones/{E.164}", where {E.164} is the user's phone number in E.164 format. For example, with the US phone number +1-222-333-4444, the resulting endpoint would be https://rcsbusinessmessaging.googleapis.com/v1/phones/+12223334444/testers/.
   */
...
export class Resource$Users {
   ...
   */
  batchGet(
    params: Params$Resource$Users$Batchget,
    options: StreamMethodOptions
  ): GaxiosPromise<Readable>;
  batchGet(
    params?: Params$Resource$Users$Batchget,
    options?: MethodOptions
  ): GaxiosPromise<Schema$BatchGetUsersResponse>;
  batchGet(
    params: Params$Resource$Users$Batchget,
    options: StreamMethodOptions | BodyResponseCallback<Readable>,
    callback: BodyResponseCallback<Readable>
  ...
  batchGet(
    params: Params$Resource$Users$Batchget,
    options: MethodOptions | BodyResponseCallback<Schema$BatchGetUsersResponse>,
    callback: BodyResponseCallback<Schema$BatchGetUsersResponse>
  ): void;
  batchGet(
    params: Params$Resource$Users$Batchget,
    callback: BodyResponseCallback<Schema$BatchGetUsersResponse>
